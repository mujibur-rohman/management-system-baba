      ...
      <div className="grid grid-cols-1 md:grid-cols-3 mt-5 gap-3">
        <div className="p-3 rounded-md flex justify-between items-center border gap-5">
          <div className="flex flex-col">
            ...
            <span className="text-lime-500 font-bold text-xl whitespace-nowrap">{countMember?.countMember || "..."}</span>
          </div>
          <UsersIcon />
        </div>
        <div className="p-3 rounded-md flex justify-between items-center border gap-5">
        ...
        <div className="p-3 rounded-md flex justify-between items-center border gap-5">
          <div className="flex flex-col">
            ...
            <span className="text-destructive font-bold text-xl whitespace-nowrap">{countStock?.totalStock || "..."} botol</span>
          </div>
          <Package2Icon />
        </div>
      </div>
