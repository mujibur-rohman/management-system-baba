...
function TeamSwitch() {
  ...
  const {
    ...
    queryKey: ["team-switch", currentPage],
    queryFn: async () => {
      return await ProductService.getSwitch({ limit: 10, page: currentPage, type: "team" });
    },
  });
  ...
  return (
    <AppWrapper className="pb-20">
      <div className="py-5 flex justify-between">
        <h1 className="text-xl md:text-2xl font-bold">Riwayat Penukaran Tim</h1>
      </div>
