...
import AddClosing from "./_components/add-closing";
...
function Closing() {
  ...
  const {
    ...
    queryKey: ["closing", currentPage, debouncedValue, monthFilter, yearFilter],
    queryFn: async () => {
      return await OrderService.getClosing({ limit: 10, page: currentPage, q: debouncedValue, month: monthFilter, year: yearFilter });
    },
  });
  ...
  return (
    <AppWrapper className="pb-20">
      <div className="py-5 flex justify-between items-center">
        <h1 className="text-xl md:text-2xl font-bold">Closingan</h1>
        <AddClosing />
      </div>
